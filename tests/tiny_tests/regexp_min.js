...
function RegExpBenchmark() {
	...
	var s6 = computeInputVariants("vachggrkg QBZPbageby_cynprubyqre",
		312);
	...
	var s17 = computeInputVariants("qvi.so_zrah",
		137);
	...
	function runBlock0() {
		for (var i =
				0; i < 6511; i++) re0.exec(s0[i]);
		for (var i = 0; i < 1844; i++) re1.exec(s1[i]);
		for (var i = 0; i < 739; i++) s2[i].replace(re2, "");
		for (var i = 0; i < 598; i++) re1.exec(s3[i]);
		for (var i = 0; i < 454; i++) re1.exec(s4[i]);
		for (var i = 0; i < 352; i++) /qqqq|qqq|qq|q|ZZZZ|ZZZ|ZZ|Z|llll|ll|l|uu|u|UU|U|zz|z|ff|f|gg|g|sss|ss|s|mmm|mm|m/g.exec(s5[i]);
		for (var i = 0; i < 312; i++) re3.exec(s6[i]);
		for (var i = 0; i < 282; i++) re4.exec(s7[i]);
		for (var i = 0; i < 177; i++) s8[i].replace(re5, "");
		for (var i = 0; i < 170; i++) {
			s9[i].replace(re6, "");
			re7.exec(s10[i])
		}
		...
		for (var i = 0; i < 144; i++) re0.exec(s13[i]);
		for (var i = 0; i < 139; i++) {
			s14[i].replace(re6, "");
			re7.exec(s14[i]);
			re9.exec("");
		...
		for (var i = 0; i < 117; i++) s18[i].replace(re2, "");
		for (var i = 0; i < 95; i++) /(?:^|;)\s*sevraqfgre_ynat=([^;]*)/.exec(s19[i]);
		for (var i = 0; i < 93; i++) {
			s20[i].replace(re12, "");
			re13.exec(s20[i])
		}
		for (var i = 0; i < 92; i++) s21[i].replace(/([a-zA-Z]|\s)+/,
			"");
		for (var i = 0; i < 85; i++) {
			s22[i].replace(re14, "");
			s22[i].replace(re15, "");
	...
	var s37 = computeInputVariants("__hgzp=144631658",
		78);
	...
	var s47 = computeInputVariants("3.5.0.0",
		70);
	...
	var s57 = computeInputVariants("uggc://sevraqf.zlfcnpr.pbz/vaqrk.psz",
		44);

	function runBlock1() {
		for (var i = 0; i < 81; i++) re8.exec(s26[i]);
		for (var i = 0; i < 78; i++) {
			s27[i].replace(/(\s)+e/, "");
			s28[i].replace(/./, "");
			s29[i].replace(re17, "");
		...
		for (var i = 0; i < 73; i++) s45[i].replace(re18,
			"");
		for (var i = 0; i < 72; i++) re1.exec(s46[i]);
		for (var i = 0; i < 71; i++) re19.exec("");
		for (var i = 0; i < 70; i++) {
			s47[i].replace(re11, "");
			s48[i].replace(/d1/g, "");
		...
		for (var i = 0; i < 49; i++) re16.exec(s56[i]);
		for (var i = 0; i < 44; i++) {
			s57[i].replace(re12, "");
			re13.exec(s57[i])
		}
	...
	var s60 = computeInputVariants("vachggrkg",
		40);
	...
	function runBlock2() {
		...
		for (var i = 0; i < 32; i++) /puebzr/i.exec(s15[i]);
		for (var i = 0; i < 31; i++) {
			s61[i].replace(re23, "");
		...
		for (var i = 0; i < 29; i++) s62[i].replace(re23, "");
		for (var i = 0; i < 28; i++) {
			s63[i].replace(re25, "");
			s63[i].replace(re12, "");
			re26.exec(s64[i])
	...
	var s78 = computeInputVariants(str18,
		27);

	function runBlock3() {
		for (var i = 0; i < 27; i++) s67[i].replace(/[A-Za-z]/g, "");
		for (var i = 0; i < 23; i++) {
			s68[i].replace(re27, "");
			s69[i].replace(re27, "")
		}
		...
		for (var i = 0; i < 19; i++) re31.exec(s73[i]);
		for (var i = 0; i < 18; i++) {
			s74[i].split(re32);
			s75[i].split(re32);
			s76[i].replace(re33, "");
	...
	var s83 = computeInputVariants(str27,
		11);
	...
	var s103 = computeInputVariants(str53,
		5);
